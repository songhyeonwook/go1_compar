...
GO1_INJURY_ONEHOT=1 GO1_PROPRIO_ONLY=1 GO1_FLAT_TERRAIN=1 GO1_PHASE2_GAIT_TUNING=1 GO1_FEET_AIR_TIME_WEIGHT="${GO1_FEET_AIR_TIME_WEIGHT:-0.1}" \
...
GO1_FLAT_ORIENTATION_WEIGHT=-2.0 GO1_SURVIVAL_BONUS_WEIGHT=1.0 GO1_TRACK_LIN_VEL_WEIGHT=6.0 \
GO1_PEG_HIP_TORQUE_SCALE=1.0 GO1_SPLINT_CALF_STIFFNESS=100 GO1_SPLINT_CALF_DAMPING=1.0 \
GO1_INJURED_FORCE_NONUSE_WEIGHT="${GO1_INJURED_FORCE_NONUSE_WEIGHT:--1.0}" GO1_INJURED_MIN_FORCE_SEVERE_N="${GO1_INJURED_MIN_FORCE_SEVERE_N:-5.0}" GO1_INJURED_MIN_FORCE_MILD_N="${GO1_INJURED_MIN_FORCE_MILD_N:-5.0}" \
GO1_INJURED_DUTY_NONUSE_WEIGHT="${GO1_INJURED_DUTY_NONUSE_WEIGHT:--1.5}" GO1_INJURED_MIN_DUTY_SEVERE="${GO1_INJURED_MIN_DUTY_SEVERE:-0.35}" GO1_INJURED_MIN_DUTY_MILD="${GO1_INJURED_MIN_DUTY_MILD:-0.35}" \
...
PHASE2_RUN_NAME="${PHASE2_RUN_NAME:-phase2_ws_${PARADIGM}_s${S}}" PHASE2_MAX_ITER="${PHASE2_MAX_ITER:-8000}" \
